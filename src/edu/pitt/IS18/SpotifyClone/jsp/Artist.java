...
//        }
    ...
    public Vector<String> getArtistRecord(){
        Vector<String> artistRecord = new Vector<>();

        artistRecord.add(artistID);
        artistRecord.add(firstName);
        artistRecord.add(lastName);
        artistRecord.add(bandName);
        artistRecord.add(bio); 
