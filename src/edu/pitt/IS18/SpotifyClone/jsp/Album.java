...
public class Album {
    ...
    public Vector<String> getAlbumRecord(){
        Vector<String> albumRecord = new Vector<>();

        albumRecord.add(albumID);
        albumRecord.add(title);
        albumRecord.add(releaseDate);
        albumRecord.add(String.valueOf(recordingCompany));
        albumRecord.add(String.valueOf(numberOfTracks));
        albumRecord.add(pmrcRating);
        albumRecord.add(String.valueOf(length));        
